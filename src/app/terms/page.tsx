    ...
    <div className="min-h-screen bg-black text-white flex flex-col">
      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="space-y-4 text-gray-300">
          <p>
            This is a placeholder for the Terms of Service page of StyleGen.
          </p>
          <p>
            In this example implementation, we've created a UI for an AI image generation service. 
            In a real implementation, this page would contain the full terms of service text regarding image generation, copyright, and usage rights.
          </p>
        </div>
      </main>
    </div>
